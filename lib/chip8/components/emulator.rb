...
module Chip8
  class Emulator
    ...
    def initialize(rom_address, to_debug)
      @memory   = Memory.new
    ...
    def open_rom(rom_address)
      path = rom_address || './roms/test_opcode.ch8'
    ...
    def execute(opcode)
      ...
      @debugger.print_message(@cycles, id, args, opcode, register.sp, register.pc, register.i, register.v) if @to_debug
